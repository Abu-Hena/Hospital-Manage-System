        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">Abu Hena</h5>
                  <span>Director</span>
                </div>
              </div>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('showdoctor')}}">
              ...
              <span class="menu-title">Outpatient Management</span>
            </a>
          </li>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('showdoctor')}}">
              ...
              <span class="menu-title">Pharmacy Management</span>
            </a>
          </li>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('showdoctor')}}">
              ...
              <span class="menu-title">Operation Theatre Management</span>
            </a>
          </li>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('showdoctor')}}">
              ...
              <span class="menu-title">Discharge Management</span>
            </a>
          </li>
